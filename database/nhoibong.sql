...
INSERT INTO `banners` (`id`, `url_anh`, `an_hien`, `thu_tu`) VALUES
	(1, 'slide4.png', 1, 1),
	(2, 'slide3.png', 1, 2),
	(3, 'slide2.png', 1, 3),
	(4, 'slide1.png', 1, 4);
...
INSERT INTO `sanpham` (`masp`, `tensp`, `giatien`, `mota`, `anhsp`, `noibat`, `bst`, `loai`) VALUES
	...
	(9, 'Thú nhồi bông bạch tuộc 2 cảm xúc', 130000.00, 'Thú nhồi bông bạch tuộc 2 cảm xúc lông mịn 3D nhiều kích thước', 'unnamed.jpg', 0, 'khong', 'tnb');
...
-- Dumping data for table nhoibong.tt_user: ~0 rows (approximately)
