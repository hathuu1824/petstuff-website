...
<html>
    <head>
        ...
        <!-- Dùng chung Font Awesome với các trang khác -->
        <link rel="stylesheet"
    ...
    <body>
            ...
            <section class="signin">
                ...
                <div class="container">
                    <div class="signin-content">
                        ...
                        <!-- IMAGE / LINK SANG ĐĂNG KÝ -->
                        <div class="signin-image">
                            <figure>
                                <img src="<%= ctx %>/images/logo.png" alt="ảnh">
                            </figure>
                            <a href="<%= ctx %>/register.jsp" class="signup-image-link">
                                Chưa có tài khoản?
                            </a>
                        </div>
        ...
        <!-- Nếu login.js dùng jQuery thì giữ vendor; nếu không dùng, có thể xóa dòng dưới -->
