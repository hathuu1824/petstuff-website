...
<html>
    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="voucher-wrap">
                ...
                <div class="button-container">
                    <a href="<%= ctx %>/voucher" class="view-btn">Xem tất cả</a>
                </div>
            </section>
            ...
            <div class="discount-container">
                ...
                <section class="deals-wrap">
                    <a class="deals-banner" href="#">
                        <img src="<%= ctx %>/images/flashsale.jpg" alt="Săn deal siêu hot">
                    </a>

                    <%
                        List<Map<String,Object>> deals =
                            (List<Map<String,Object>>) request.getAttribute("deals");
                    %>
                    ...
                    <div class="deals-grid">
                        <% if (deals != null && !deals.isEmpty()) {
                            ...
                            <article class="deal-card">
                                <a class="deal-image"
                                   href="<%= ctx %>/sanpham?id=<%= d.get("id") %>">
                                    <img src="<%= ctx %>/images/<%= d.get("img") %>"
                                         alt="<%= d.get("tensp") %>">
                                </a>
        ...
        <!-- ========== SCRIPTS ========== -->
        <script src="<%= ctx %>/javascript/discount.js"></script>
    </body>
</html>
