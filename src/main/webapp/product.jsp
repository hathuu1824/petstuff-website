                        ...
                        <div class="user-menu">
                            ...
                            <div class="user-popup">
                                <div class="user-popup-header">
                                    <img src="<%= ctx %>/images/avatar-default.png"
            ...
            <div class="subbar">
                <nav class="subnav">
                    <ul class="subnav-list">
                        <li>
                            <a href="<%= ctx %>/trangchu">Trang chủ</a>
                        </li>
        ...
        <main>
            <h1 class="heading">
                <% if (loai == null) { %>
                    TẤT CẢ SẢN PHẨM
                <% } else { %>
                    <% if ("changoi".equals(loai)) { %>
                        CHĂN GỐI HÌNH THÚ
                    <% } else if ("mockhoa".equals(loai)) { %>
                        MÓC KHÓA
                    <% } else if ("tnb".equals(loai)) { %>
                        THÚ NHỒI BÔNG
                    <% } else { %>
                        SẢN PHẨM KHÁC
                    <% } %>
                    ...
                    <% for (Map<String,Object> p : list) { %>
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <%
                                    BigDecimal giaGoc = (BigDecimal) p.get("giatien");
                                    BigDecimal giaKm  = (BigDecimal) p.get("giakm");

                                    NumberFormat vn =
                                        NumberFormat.getInstance(new java.util.Locale("vi","VN"));
                                    vn.setGroupingUsed(true);

                                    String goc = vn.format(giaGoc.longValue()) + "₫";

                                    boolean hasKm = (giaKm != null
                                        && giaKm.compareTo(BigDecimal.ZERO) > 0
                                ...
                                <a class="btn"
                                   href="<%= ctx %>/chitiet?id=<%= p.get("masp") %>">
                                    Xem chi tiết
                                </a>
                            </div>
                        </div>
